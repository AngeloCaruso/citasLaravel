...
<div class="row justify-content-center">
    <div class="col-12 col-sm-6">
        <div class="card mt-5">
            ...
            <div class="card-body">
                <form autocomplete="off" class="form" role="form" action="{{ url('/citas') }}" method="post">
                    {{csrf_field()}}
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="form-control" name="user_id" required>
                                ...
                                <option value="{{$usuarioAct->id}}">{{$usuarioAct->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col-8">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mb-0">{{$medico->especialidad}}</p>
                                            <p class="card-text"><small class="text-muted">{{$medico->ciudad}}</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
